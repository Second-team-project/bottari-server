/**
 * @file app/middlewares/validations/fields/FAQ.field.js
 * @description FAQ 유효성 검사 필드
...
export const image = body('image')
  ...
  .custom(val => {
    ...
    if(!val.startsWith(`${process.env.APP_URL}${process.env.ACCESS_FILE_FAQ_IMAGE_PATH}`)) {
      return false;
    }
